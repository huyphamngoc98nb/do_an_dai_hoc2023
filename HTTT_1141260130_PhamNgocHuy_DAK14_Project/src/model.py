...
class WBNCF(BaseModel):
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument("--embedding_dim", default=64, type=int, help="Encoder associated embedding feature dimensions")
        parser.add_argument("--neighbor_embedding_dim", default=32, type=int, help="Encoder Neighbor Feature Dimension")
        parser.add_argument("--hidden_dims", type=int, default=(64, 32), nargs="+", help="The number of hidden units per layer of the decoder")
